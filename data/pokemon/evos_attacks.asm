; feature/completion: the demo commented out evolutions for demo-available species
; (starters Happa/Honoguma/Kurusu, Pidgey/Rattata/Ekans/Pikachu, Hoho/Mitsuboshi/Poponeko)
; to stop them evolving in the demo. They have been restored (uncommented) for the full game.
;
; Eevee's evolution list was missing its terminating `db 0`, corrupting its data;
; that terminator has been restored too. (See EeveeEvosAttacks.)
